...
Just like last week, one of the traits of a great programmer is their ability to solve a problem they haven't seen before. One of the best ways to solve a problem you have not seen before is to see if anyone else has. Great programmers are experts of web searching. As we are working on becoming expert programmers, this week I have included the link to a set of Rstudio cheat sheets all about the different functionalities in the tidyverse. The two most helpful for this week's assignment are the sheets on dplyr and tidyr. https://www.rstudio.com/resources/cheatsheets/
