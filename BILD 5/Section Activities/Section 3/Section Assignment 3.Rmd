...
2.(0.5 point): You will need to read in the data table that you created in last week's section activity. Assign that .csv file to the "HospitalData" object on the line below:
...
Then upload the pdf file to canvas/gradescope under the Week 3 Section Assignment before the deadline. 
