...
Answer the following questions by typing the appropriate code in the code boxes (denoted by ``` signs). In some boxes I have included some of the code necessary to complete the question as a hint. If you can think of a different way answer the question, feel free to delete my code, however, make sure you read each question carefully. 
...
SurvivalRate
#or
SurvivalRate<-DataWeek2$Survivors/DataWeek2$Operations
SurvivalRate
...
```{r}
write.csv(x = DataWeek2new,file = "Week2SA.csv")
```
\newpage
